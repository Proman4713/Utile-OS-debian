...
2. Rename the directory accordingly (for human understanding: `base-files-14ubuntu6/` was renamed to `base-files-abstract_all/`) and introduce a new entry to the Debian changelog file (`14ubuntu6` becomes `14ubuntu6utile1`).
